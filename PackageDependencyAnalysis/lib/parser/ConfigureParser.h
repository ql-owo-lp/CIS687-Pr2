...
private:
	...
	SimicolonDetector* pSimicolonDetector;

	ScopeDetector* pSDetector[4];
	PushScope* pPushS[3];

	PushType* pPushType;
	PushTypeInheritance* pPushTypeInheritance;

	TypeDefDefinition* pTypeDefDefinition;
	PushTypeDef* pPushTypeDef;

	PushArgument* pPushArgument;
	PushField* pPushField;

	PreprocStatement* pPreprocStatement;
	PushInclude* pPushInclude;

	UsingNamespaceDefinition* pUsingNamespaceDefinition;
	PushUsingNamespace* pPushUsingNamespace;

	BracketStatementDefinition *pBSDefinition[6];
	PushBracketStatement *pPushBS[7];
